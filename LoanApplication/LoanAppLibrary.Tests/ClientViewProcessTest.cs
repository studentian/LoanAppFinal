...
namespace LoanAppLibrary.Tests
{
        ...
        //CA4 Part A - Unit Test of the Client View Input Validation process
    {
        ...
        //Test method
        public void ValidateClientViewInput_ValuesShouldVerify(int tboxUserId, decimal tboxAffExpenses, decimal tboxRpmtPurchasePrice, decimal tboxRpmtDeposit, int tboxAffTerm, bool expected)
        //bool expected is the value we expect to come out of the test
        {
            //arrange
            ClientViewProcess clientViewProcess = new ClientViewProcess();//creates an instance of the clientViewProcess

            //Act
            //actual - the strings or actual values are being feed into the method here. Note that data types are not needed here. 
            bool actual = clientViewProcess.ValidateUserInput( tboxUserId,  tboxAffExpenses, tboxRpmtPurchasePrice,  tboxRpmtDeposit,  tboxAffTerm); 
